...
import { DbValidationError } from "@/lib/db-helpers"
...
describe("Database Schema Validation", () => {
  ...
  describe("Email Order Schema", () => {
    ...
    it("should reject invalid status", () => {
      ...
      const result = insertEmailOrderSchema.safeParse(invalidOrder)
      expect(result.success).toBe(false)
    })
  ...
  describe("Update Profile Form", () => {
    it("should validate correct profile update data", () => {
      const validData = {
        name: "Jane Doe",
        email: "jane@example.com",
        enterpriseEmail: "jane@company.com",
        countryCode: "US",
      }

      const result = formSchemas.updateProfile.safeParse(validData)
      expect(result.success).toBe(true)
    })
    ...
    it("should reject invalid country code", () => {
      ...
      const result = formSchemas.updateProfile.safeParse(invalidData)
      expect(result.success).toBe(false)
    })
  })
})
...
describe("Database Helpers Validation", () => {
  describe("DbValidationError", () => {
    it("should create proper validation error", () => {
      ...
      if (!result.success) {
        ...
        const error = new DbValidationError(result.error as any)
  ...
  describe("User Helpers Validation", () => {
    it("should validate user creation data", () => {
      ...
      // Test that validation schema passes
      const result = insertUserSchema.safeParse(validUser)
      expect(result.success).toBe(true)
    })
